...
const Mint = () => {
  return (
    <div id='mint' className='flex flex-col pt-4 px-5 pb-[72px] lg:mt-[-184px] lg:pb-40 lg:mx-auto'>
      ...
      <div className='hidden lg:grid grid-cols-2 gap-16 px-56'>
        <div>
        ...
        <div className='flex flex-col'>
          ...
          <br />
          <p className='text-2xl font-sfui'>
            Now you don't need to worry about it. Create impressive AI-generated Taproot Assets with Milo's "AI-MINTER".
          </p>
          <br />
          <p className='text-2xl font-sfui'>
            By entering text prompts or uploading photos, Milo holders can create stunning AI-generated Taproot Assets for their own Bitcoin NFTs.
          ...
          <br />
          <span className='rounded bg-dark-box py-[18px] px-[74px] text-gold font-sfui font-bold text-lg leading-[18px] w-fit'>COMING SOON</span>
        </div>
      </div>
    </div>
  );
