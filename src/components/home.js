...
const Home = () => {
  ...
  return (
    <div id='home' className='flex flex-col justify-center items-center m-auto lg:pt-24 pt-11 z-2 relative'>
      ...
      <img src={banner} alt='banner' className='z-10 scale-[1.03] lg:scale-100 ml-[-20px]' />
      <div className='z-10 flex flex-col py-28'>
      ...
      <div className='z-10 bg-gold py-2 w-screen overflow-hidden whitespace-nowrap box-border items-center m-auto'>
      ...
      <div className='hidden lg:block right-anim z-0 top-0'>
        <img src={ExAnimLine} alt='lines' />
      </div>
      <div className='hidden lg:block z-0 left-anim top-0'>
        <img src={ExAnimLine} alt='lines' />
      </div>
      <div className='lg:hidden z-0 main-anim top-0'>
