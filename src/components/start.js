...
const Start = () => {
  return (
    <div id='start' className='flex flex-col w-full road-bg'>
      <span className='text-center section-title pt-5 lg:pt-[68px] pb-7 lg:pb-[88px]'>Getting Started</span>
      <div className='flex flex-col lg:flex-row gap-[30px] lg:gap-14 w-full px-10 lg:px-56 pb-[58px] lg:pb-[202px]'>
        ...
        <div className='flex-1 flex flex-col'>
          <img src={secondTap} alt='tap2' className='rounded-tl-[5px] rounded-tr-[5px] border-b-0' />
          <div className='flex flex-row mt-[-1px] lg:mt-[-2px]'>
            <span className='flex-1 px-[18px] py-4 rounded-bl-[5px] bg-dark-box text-light-text text-base leading-[19px] lg:px-7 lg:text-2xl lg:leading-7 font-sfui'>
        ...
        <div className='flex-1 flex flex-col'>
          <img src={thirdTap} alt='tap3' className='rounded-tl-[5px] rounded-tr-[5px] border-b-0' />
          <div className='flex flex-row mt-[-1px] lg:mt-[-2px]'>
            <span className='flex-1 px-[18px] py-4 rounded-bl-[5px] bg-dark-box text-light-text text-base leading-[19px] lg:px-7 lg:text-2xl lg:leading-7 font-sfui'>
